                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="adjustment_type" id="add_stock" value="add" checked>
                                        <label class="form-check-label" for="add_stock">
                                            <i class="bi bi-plus-circle text-success me-1"></i> Add to Inventory
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="adjustment_type" id="remove_stock" value="remove">
